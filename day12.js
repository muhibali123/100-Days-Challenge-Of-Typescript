...
var pizzas = ["peproni pizaa", "chicken tikka ", "chicken fajita"];
...
var wildanimals = ["Tiger", "Lion", "Elephant", "Deer"];
wildanimals.forEach(function (wildanimals) {
    console.log("".concat(wildanimals, " is a wild animal"));
});
...
function makingshirt(size, messages) {
    console.log("making a ".concat(size, " size t-shirt with the messages ").concat(messages, " printed on it"));
}
