...
//let guests: string[] = ["Huzaifa", "Haseeb", "Shariq", "Abdullah", "Muhib" , "Usman"];
...
//let cities :string[] =["Karach","Hyderabad","Islamabad","lahore"]
...
//let book :{bookname :string ; Author : string ; Releasedate : number;}={
//    bookname : "Atomic Habit",
//    Author   : "James Clear",
//    Releasedate: 2018
//}

//console.log(`book information : ${book.bookname}, book Author : ${book.Author} , Book release date : ${book.Releasedate}`)
