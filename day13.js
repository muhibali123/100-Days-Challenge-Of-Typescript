...
function cities(city, country) {
    ...
    console.log("the city name is ".concat(city, " and it is presented in ").concat(country));
}
cities("Karachi");
cities("Hyderabad");
cities("Dubai", "UAE");
...
//   return `${city},${country}`;
// }
// console.log(cities("New York City", "USA"));
// console.log(cities("Paris", "France"));
// console.log(cities("Beijing", "China"));
